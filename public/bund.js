...
/***/ function(module, exports, __webpack_require__) {
	...
	var _main_router = __webpack_require__(3);

	var _main_router2 = _interopRequireDefault(_main_router);

	var _app_config = __webpack_require__(11);
	...
	var _module3 = __webpack_require__(18);
	...
	// 'oc.lazyLoad',
	'ui.router', _module2.default.name, _module4.default.name]);

	application.config(_main_router2.default);
	application.run(_app_config2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = ["$stateProvider", "$urlRouterProvider", "$locationProvider", function ($stateProvider, $urlRouterProvider, $locationProvider) {
	    ...
	    }).state('app.module1', _config2.default.route).state('app.module1.sub', _config4.default.route).state('app.module2', _config6.default.route).state('app.module2.sub', _config8.default.route);
	...
	var _config3 = __webpack_require__(6);

	var _config4 = _interopRequireDefault(_config3);

	var _config5 = __webpack_require__(8);

	var _config6 = _interopRequireDefault(_config5);

	var _config7 = __webpack_require__(10);
...
/***/ function(module, exports) {
	...
	module.exports = "<div ui-view></div>\r\n{{ctrl.store.model.data}} variable value! <br/>\r\n{{ctrl.store.model.another}} variable here! <button ng-click=\"ctrl.onClick()\">UPDATE</button>"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _controller3 = __webpack_require__(14);
	...
	angular.module('app.module1', []).controller('Module1Ctrl', _controller2.default).controller('SubCtrl', _controller4.default).factory('Factory', _store2.default);

	exports.default = angular.module('app.module1');
...
/***/ function(module, exports) {
	...
	var SubCtrl = function SubCtrl() {
	    'ngInject';

	    _classCallCheck(this, SubCtrl);
	};

	exports.default = SubCtrl;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = ["$timeout", function ($timeout) {
	    ...
	    store.model = _model2.default;

	    store.worker = new _actions2.default();
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function() {
		return new Worker(__webpack_require__.p + "6aa84467f2477caa599a.worker.js");
	};
...
/***/ function(module, exports) {
	...
	exports.default = angular.module('module2', []);
